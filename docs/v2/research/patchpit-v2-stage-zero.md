...
The former handoff goals translate into candidate invariants rather
...
- `docs/v2/research/app-shortcut-instance-brief.md`
- `docs/v2/research/filesystem-runtime-shape-brief.md`
...
- `docs/v2/research/patchpit-v2-stage-zero.md`
